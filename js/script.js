...
const config = {
    serverInfo: {
        ...
        serverName: "Bhaichara-SMP", /*Server name*/
        serverIp: "bhaicharasmp.oops.wtf:25535", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1320120939471441990" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
